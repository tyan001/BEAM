...
def load_and_prepare_data(csv_path):
    ...
    # combined the Impaired Not SCD/MCI and Subjective Cognitive Decline and call it Impaired Not SCD/MCI and SCD
    df['FL_UDSD'] = df['FL_UDSD'].replace('Impaired Not SCD/MCI', 'Subjective Cognitive Decline')
    df['FL_UDSD'] = df['FL_UDSD'].replace('Subjective Cognitive Decline', 'Impaired Not SCD/MCI and SCD')
    
    # Create categorical encoding
    cat_order = ['Normal cognition', 'Impaired Not SCD/MCI and SCD', 'Early MCI', 'Late MCI', 'Dementia']
...
def main():
    ...
    output_file = "comprehensive_feature_search_results_INSCD_SCD.xlsx"
    min_features = 2
