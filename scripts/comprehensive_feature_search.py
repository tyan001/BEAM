...
def load_and_prepare_data(csv_path):
    ...
    cat_order = ['Normal cognition', 'Subjective Cognitive Decline', 'Impaired Not SCD/MCI', 'Early MCI', 'Late MCI', 'Dementia']
...
def main():
    ...
    output_file = "comprehensive_feature_search_results.xlsx"
    min_features = 2
